...
import io.github.fbiville.neo4j.ImportCommand
import java.io.BufferedReader
import java.io.FileInputStream
import java.io.InputStreamReader
import java.nio.charset.StandardCharsets

@Parameters(commandDescription = "Imports drug packagings into Neo4j")
class PackageImportCommand : ImportCommand {

    @Parameter(names = arrayOf("-f", "--defined-in"), required = true, description = "Path to TSV file")
    ...
    override fun performImport() {
        val importer = PackageImporter(boltUri, username, password)
